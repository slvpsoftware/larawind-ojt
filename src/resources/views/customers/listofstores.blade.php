    ...
    <main>
                            ...
                            @endif
                                <td>
                                    <div class="grid justify-items-center mx-2 mt-4">
                                        ...
                                        <a href="#"><p class="mt-2 text-xs uppercase tracking-wider text-blue-500 dark:text-blue-400">View Products</p></a>
                                    </div>
                                </td>
        ...
        <p class="mt-4 text-center text-gray-500 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nostrum quam voluptatibus</p> --}}
                ...
                <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-12 xl:grid-cols-3 xl:gap-12">
                    ...
                    <div>
                        <img class="h-96 w-full rounded-lg object-cover"
                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdBjcbP29ZoU_7r2Fn46hp2kRyx9VVeK6GA3m3FQfJYLEK0X2h63J4X9Lf4HPgwAIiuIM&usqp=CAU"
                            alt="" />
                ...
                <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-3">
                    <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                        <img class="aspect-square w-full rounded-xl object-cover"
                            src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/e49d24c6-b958-4bd7-ac83-deabde99d70e/dex4zqm-a861248e-62c7-4d5e-b244-f6dc99457746.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..c7iqAu28D3xyDLQVjJmHApdm7NWUQUh-hd7D5T4rUG0"
                            alt="" />
                    ...
                    <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                        <img class="aspect-square w-full rounded-xl object-cover"
                            src="https://rare-gallery.com/mocahbig/1375173-luffy-gear-5-sun-god-nika-one-piece-4k-pc-wallpaper.jpg"
                            alt="" />

                        <h1 class="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">monkey d. luffy
                        </h1>
                    ...
                    <div class="flex flex-col items-center rounded-xl border p-4 dark:border-gray-700 sm:p-6">
                        <img class="aspect-square w-full rounded-xl object-cover"
                            src="https://i.pinimg.com/originals/9d/f8/89/9df8896fa08451a7943b873c95462341.jpg"
                            alt="" />

                        <h1 class="mt-4 text-2xl font-semibold capitalize text-gray-700 dark:text-white">Sanji Vinsmoke
                        </h1>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="container mx-auto px-6 py-10">
                <div class="text-center">
                    <h1 class="text-3xl font-semibold capitalize text-gray-800 dark:text-white lg:text-4xl">From the blog
                    </h1>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="container mx-auto max-w-4xl px-6 py-10">
                ...
                <div class="mt-12 space-y-8">
                    ...
                    <div class="rounded-lg border-2 border-gray-100 dark:border-gray-700">
                        <button class="flex w-full items-center justify-between p-8">
                            <h1 class="font-semibold text-gray-700 dark:text-white">Is the cost of the appoinment covered
                                by private health insurance?</h1>
