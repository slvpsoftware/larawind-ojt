                ...
                <section
                    ...
                    <div x-show="isLoginPage" class="space-y-4">
                        ...
                        <div class="w-full rounded-2xl bg-gray-200 px-4 ring-2 ring-gray-200 focus-within:ring-blue-400">
                            ...
                            style="resize:none" name="product_description" placeholder="Description" class="my-3 w-96 border-none bg-transparent outline-none focus:outline-none"></textarea>
