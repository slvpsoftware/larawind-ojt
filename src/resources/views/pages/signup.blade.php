            ...
            <!-- register content -->
             <form action={{route('signup')}} method="POST">
                ...
                <div x-show="isLoginPage" class="space-y-4">
                    ...
                    <button class="w-48 rounded-2xl border-b-4 border-b-violet-600 bg-violet-500 py-3 font-bold text-white hover:bg-violet-400 active:translate-y-[0.125rem] active:border-b-violet-400">
                            CREATE ACCOUNT
                    </button>
                </div>
