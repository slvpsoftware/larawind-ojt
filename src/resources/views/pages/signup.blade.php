        ...
        <header class="flex w-full justify-between">
            ...
            <div class="flex space-x-4">
                <a href="{{route('login')}}" x-show="isLoginPage"
                    class="rounded-2xl border-b-2 border-b-gray-300 bg-blue-500 py-3 px-4 font-bold text-white ring-2 ring-gray-300 hover:bg-gray-200 text-blue active:translate-y-[0.125rem] active:border-b-gray-200">
                    LOGIN
                 </a>
            ...
            @csrf
                <section
                    ...
                    {{-- <div x-show="!isLoginPage" class="space-y-4">
                        ...
                        <div class="w-full rounded-2xl bg-gray-50 px-4 ring-2 ring-gray-200 focus-within:ring-blue-400">
                            <input type="text" name="username" placeholder="sername"
                                class="my-3 w-full border-none bg-transparent outline-none focus:outline-none" />
                        </div>
                        <div
