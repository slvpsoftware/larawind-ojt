    ...
    <div class="p-6" x-data="app">
        ...
        <section
            ...
            <form action={{route('adminlogin')}} method="POST">
                <!-- login content -->
                <div x-show="!isLoginPage" class="space-y-4">
                    <header class="mmb-3 text-4xl text-violet-800  font-bold">Login</header>
                    <br>
                    @csrf
                    ...
                    <button class="w-36 rounded-2xl border-b-4 border-b-violet-600 bg-violet-500 py-3 font-bold text-white hover:bg-violet-400 active:translate-y-[0.125rem] active:border-b-violet-400">
                            LOG IN
                    </button>
                </div>         
            </form>
